...
samp_df %>% write_csv("./data/student_happiness.csv")
...
happiness_model <- lm(happiness ~ min_outdoors + min_zoom + civil + mechanical + electrical + undergrad + masters + phd, data = pop_df)
